...
export const createProduct = (productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `/api/product/admin/createproduct`,
      productData,
      config
    );
...
export const updateProduct = (id, productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `/api/product/admin/updateproduct/${id}`,
      productData,
      config
    );
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `/api/product/createproductreview`,
      reviewData,
      config
    );
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `/api/product/admin/deleteproduct/${id}`
    );
    console.log(data);
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/product/getproductreviews?id=${id}`);
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `/api/product/deletereview?id=${reviewId}&productId=${productId}`
    );
